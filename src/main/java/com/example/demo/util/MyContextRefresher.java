...
import static com.example.demo.util.MyBaseApplicationContextInitializer.TEMP_CONTEXT_NAME;

/**
 * Created by Administrator on 2018/5/21.
 */
public class MyContextRefresher extends ContextRefresher {
    ...
    private void addConfigFilesToEnvironment() {
        ...
        try {
            ...
            SpringApplicationBuilder builder = new SpringApplicationBuilder(Empty.class)
                    .bannerMode(Banner.Mode.OFF).web(false).properties(TEMP_CONTEXT_NAME + "=true").environment(environment);
